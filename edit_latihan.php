...
$stmt = $conn->prepare("SELECT * FROM tabel_latihan WHERE id_latihan = ?");
            ...
            <div class="card-body">
                ...
                <form method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" name="judul" id="judul" class="form-control" value="<?= htmlspecialchars($materi['judul_latihan']) ?>" required>
                    </div>
                    <div class="mb-3">
